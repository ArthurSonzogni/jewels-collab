# Conditions Générales d’Utilisation (CGU) – Vincent arnould

## 1\. Introduction

Les présentes Conditions Générales d’Utilisation (ci-après les « CGU ») ont pour objet de définir les modalités d’accès et d’utilisation du site **Vincent arnould** (ci-après le « Site »).

Le Site est une plateforme en ligne dédiée à la **vente d’articles de joaillerie et de bijouterie**, proposée par vincent arnould. Il s’adresse exclusivement à un **public de particuliers**, souhaitant consulter ou acheter les produits proposés à la vente.
...
_Dernière mise à jour : 1 Juin 2025_
=======
  # Conditions Générales d’Utilisation (CGU) – vincentarnould.com
  
  ## 1. Introduction
  
  Les présentes Conditions Générales d’Utilisation (ci-après les « CGU ») ont pour objet de définir les modalités d’accès et d’utilisation du site **vincentarnould.com** (ci-après le « Site »).
  ...
  - **Site** : désigne le site internet vincentarnould.com accessible à l’adresse https://vincentarnould.com/.
  - **Utilisateur** : toute personne naviguant sur le Site, qu’elle soit simple visiteuse ou acheteuse.
  - **Vendeur** : désigne l’exploitant du Site qui propose les produits à la vente.
  - **Produit** : désigne tout article de joaillerie ou de bijouterie proposé sur le Site.
